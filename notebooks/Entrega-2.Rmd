...
- Calcula i representa la distribució posterior predictiva.

(recorda com era la distribució binomial negativa)


- Estima la probabilitat de què el nombre de defuncions l’any vinent sigui $k_\text{new} = 60.000$ i de què el nombre de defuncions sigui $60.000 < k_\text{new} < 61.000$.
